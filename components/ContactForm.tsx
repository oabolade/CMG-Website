...
export function ContactForm() {
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-primary/5 to-secondary/5" id="contact">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      aria-label="Call Crowns Medical Group at +1 (234) 567-890"
                    >
                      +1 (234) 567-890
                    </a>
                  </div>
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:info@crownsmedical.com"
                      className="text-primary hover:underline font-medium break-all"
                      aria-label="Email Crowns Medical Group at info@crownsmedical.com"
                    >
                      info@crownsmedical.com
                    </a>
                  </div>
                </div>
              </CardContent>
